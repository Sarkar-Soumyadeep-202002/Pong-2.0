...
# SPACE_BG = pygame.image.load("Assets/space_background.png")
HALLOWEEN_BG = pygame.image.load("Assets/halloween_background.png")
# JUNGLE_BG = pygame.image.load("Assets/jungle_background.png")
# FANTASY_BG = pygame.image.load("Assets/fantasy_background.png")
...
class Game:
    ...
    def _update_screen(self):
        ...
        screen.blit(HALLOWEEN_BG, (0, 0))
        # screen.blit(JUNGLE_BG, (0, 0))
        # screen.blit(FANTASY_BG, (0, 0))
